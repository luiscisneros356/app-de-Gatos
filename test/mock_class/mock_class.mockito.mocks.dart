...
// in challenge_flutter/test/mock_class/mock_class.mockito.dart.
...
/// A class which mocks [HiveGetCatsDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockHiveGetCatsDataSource extends _i1.Mock
    implements _i7.HiveGetCatsDataSource {
  @override
  _i3.Future<void> saveCats(List<_i8.Cat>? listCats) => (super.noSuchMethod(
        Invocation.method(
          #saveCats,
          [listCats],
        ),
  ...
  @override
  List<_i8.Cat> getCats() => (super.noSuchMethod(
        Invocation.method(
          #getCats,
          [],
        ),
        returnValue: <_i8.Cat>[],
        returnValueForMissingStub: <_i8.Cat>[],
      ) as List<_i8.Cat>);
}
